/*!
Syuyechka 的 Substore 订阅转换脚本 (fork from powerfullz/override-rules)
https://github.com/Syuyechka/override-rules
  ...
  function buildProxyGroups({
    ...
    const groups = [
      ...
      },
      {
        ...
        icon: `${CDN_URL}/gh/Syuyechka/override-rules@main/icons/Microsoft_Copilot.png`,
        type: "select",
        proxies: defaultProxies
      },
      {
      ...
      },
      {
        ...
        icon: `${CDN_URL}/gh/Syuyechka/override-rules@main/icons/Telegram.png`,
        type: "select",
        proxies: defaultProxies
      },
      {
      ...
      },
      {
        ...
        icon: `${CDN_URL}/gh/Syuyechka/override-rules@main/icons/Truth_Social.png`,
        type: "select",
        proxies: hasUS ? [`美国节点`, PROXY_GROUPS.SELECT, PROXY_GROUPS.MANUAL] : defaultProxies
      },
      {
        name: PROXY_GROUPS.EHENTAI,
        icon: `${CDN_URL}/gh/Syuyechka/override-rules@main/icons/Ehentai.png`,
        type: "select",
        proxies: defaultProxies
      },
      {
      ...
      },
      {
        ...
        icon: `${CDN_URL}/gh/Syuyechka/override-rules@main/icons/Sougou.png`,
        type: "select",
  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `RULE-SET,Zoom,${PROXY_GROUPS.ZOOM}`,
    ...
    "src/rule_providers.ts"() {
      ...
      ruleProviders = {
        ...
        TikTok: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/Syuyechka/override-rules@main/ruleset/TikTok.list`,
        ...
        EHentai: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/Syuyechka/override-rules@main/ruleset/EHentai.list`,
        ...
        SteamFix: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/Syuyechka/override-rules@main/ruleset/SteamFix.list`,
        ...
        GoogleFCM: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/Syuyechka/override-rules@main/ruleset/FirebaseCloudMessaging.list`,
        ...
        AdditionalFilter: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/Syuyechka/override-rules@main/ruleset/AdditionalFilter.list`,
        ...
        AdditionalCDNResources: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/Syuyechka/override-rules@main/ruleset/AdditionalCDNResources.list`,
        ...
        Weibo: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/Syuyechka/override-rules@main/ruleset/Weibo.list`,
    ...
    "src/main.ts"() {
      ...
      function main(config) {
        if (!config.proxies || !Array.isArray(config.proxies)) {
          throw new Error("[Syuyechka 的覆写脚本] 错误：Clash 配置中缺少有效的 proxies 字段");
        }
